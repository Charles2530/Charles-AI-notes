...
![Open X-Embodiment dataset diversity](../assets/images/paper-figures/vla/openx-data-vis.jpg){ width="920" }

<small>图源：[Open X-Embodiment: Robotic Learning Datasets and RT-X Models](https://arxiv.org/abs/2310.08864)，Figure 1。原论文图意：展示来自全球多家机构的开放大规模机器人学习数据集，覆盖不同机器人形态、环境和行为。</small>

!!! note "图解：VLA benchmark 和数据引擎为什么必须一起看"
...
### 把 **VLA 的 Benchmark 与数据引擎** 放回闭环系统里讨论
