...
### 把 **激活离群值与校准策略** 从方法名写成设计空间

这一类页面如果只停留在“概念、公式、论文关系”，读者很容易知道名词却不知道何时该用、何时不该用。围绕 **激活离群值与校准策略**，更扎实的写法应当把它放回一个明确设计空间：

1. **outlier 位置、校准集、组大小、长度分布、模态分布**。

只有把这些坐标讲清楚，读者才能理解：某种方法为什么在论文里成立、落到工程里时最容易在哪些环节变形，以及它和相邻方法的真正边界在哪里。

### 更实用的分析顺序

围绕 **激活离群值与校准策略**，建议读者和实践者都先按下面顺序思考：
...
围绕 **激活离群值与校准策略**，常见失败并不只是“指标低”，更常见的是：
...
做到这一步后，**激活离群值与校准策略** 才会从“资料页”升级成“真正能指导设计决策的页面”。
